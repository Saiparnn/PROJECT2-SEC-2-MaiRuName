...
import MovieBox from "../view/MovieBox.vue";
    ...
    <div class="flex bg-[#FBEEC1] pt-2 pb-2">
      ...
      <div class="absolute right-0 justify-items-end mt-1">
        ...
        <div v-if="isOpen" class="absolute right-2 mt-1 py-2 w-48 bg-[#BC986A] rounded-lg text-white">
          <p class="block px-4 py-2 hover:bg-white hover:text-[#BC986A]">Your Profile</p>
          <p class="block px-4 py-2 hover:bg-white hover:text-[#BC986A]">Sign Out</p>
        </div>
      </div>
    </div>
  </div>
