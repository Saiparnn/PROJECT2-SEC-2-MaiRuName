...
const genre = ref(['Romance','Comedy','Horror','Thriller','Mystery','Drama','Action','Sci-Fi','Animation','Adventure','Fantasy', 'Crime','War','Others',])
...
<template>
  <div class="flex bg-[#FBEEC1] pt-2 pb-2">
    ...
    <nav class="flex text-[#BC986A] items-center mt-1">
      ...
      <Dropdown title="Genre" :genre = "genre"/>
<!--      <DropDrop />-->
